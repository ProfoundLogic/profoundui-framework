...
pui.Grid = function() {
  ...
  this.getPropertiesModel = function() {
    var model = [
      ...
      { name: "initial page number", format: "number", help: "Specifies the initial page number to use when the page number is display within the paging bar.", context: "dspf" },
