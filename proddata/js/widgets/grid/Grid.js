...
pui.Grid = function () {
  ...
  pui.Grid.helpTextGridProperties = function(defVal, descVal, descAdd, noteVal) {
  ...
  this.getPropertiesModel = function () {
    var model = [{ name: "Identification", category: true },
      { name: "id", maxLength: 75, attribute: "id", help: pui.Grid.helpTextGridProperties("id","Sets the ID of the grid.",[],""), bind: false, canBeRemoved: false },
      { name: "record format name", help: pui.Grid.helpTextGridProperties("blank","Specifies the record format that is used to access this grid from server code.",[],""), maxLength: (pui.viewdesigner ? null : 10), bind: false, context: "dspf", canBeRemoved: false },
      { name: "description", help: pui.Grid.helpTextGridProperties("blank","Describes the record format.",[],""), bind: false, context: "dspf" },
      { name: "parent window", attribute: "parentWindow", help: pui.Grid.helpTextGridProperties("blank","Sets the window that this field belongs to.",[],""), context: "genie" },
      { name: "screen identifier", choices: ["true", "false"], blankChoice: false, help: pui.Grid.helpTextGridProperties("false","If set to true, this element will be used to detect the screen. The identifier element should be a static output field that is unique to this screen. For example, if the screen has a unique heading, it can be used as the identifier. At least one element on the screen must be marked as an identifier before you can save the screen. When appropriate, you can use a combination of several elements to uniquely identify the screen.",[],""), context: "genie" },
      { name: "field type", displayName: "widget type", choices: ["grid"], blankChoice: false, help: pui.Grid.helpTextGridProperties("widget","Determines the type of control that is used to render the element.",[],""), bind: false, canBeRemoved: false },
      { name: "value", help: pui.Grid.helpTextGridProperties("blank","Sets the initialization value for the current element.",[],"") },

      { name: "Subfile Settings", category: true, context: "dspf" },
      { name: "display subfile", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("true","This property tells the system when to display grid records. It represents the SFLDSP keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "display control record", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property tells the system when to display the subfile control record. It represents the SFLDSPCTL keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "initialize subfile", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property tells the system to initialize all records within the subfile. It represents the SFLINZ keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "subfile records not active", choices: ["true", "false"], bind: false, help: pui.Grid.helpTextGridProperties("false","This property can be used together with the \"initialize subfile\" property to initialize a subfile with no active records. It represents the SFLRNA keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "delete subfile", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property tells the system when to delete the subfile area. It represents the SFLDLT keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "clear subfile", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property tells the system when to clear all records from the subfile. It represents the SFLCLR keyword.",[],""), context: "dspf", viewdesigner: false },
      { name: "subfile size", format: "number", hideFormatting: true, validDataTypes: ["zoned"], help: pui.Grid.helpTextGridProperties("blank","This property represents the SFLSIZ keyword, which specifies the number of records that can be placed into the subfile. However, if your program places a record with a relative record number larger than the SFLSIZ value into the subfile, the subfile is automatically extended to contain it (up to a maximum of 9999 records). If this property is not specified, the subfile page value plus one is used. The subfile page value is determined from the \"number of rows\" property minus the header row if it is present.",[],""), context: "dspf", viewdesigner: false },
      { name: "subfile record number", format: "number", hideFormatting: true, validDataTypes: ["zoned", "reference"], help: pui.Grid.helpTextGridProperties("blank","This property identifies the scrollbar position when the subfile is first displayed." + (pui.viewdesigner ? "" : "  It represents the SFLRCDNBR keyword."),[],""), context: "dspf" },
      { name: "position at top", choices: ["true", "false"], bind: false, help: pui.Grid.helpTextGridProperties("false","When this property is set to true, the subfile record identified by the \"subfile record number\" property will display in the top row of the grid." + (pui.viewdesigner ? "" : "  This property is equivalent to the SFLRCDNBR(*TOP) keyword."),[],""), context: "dspf" },
      { name: "place cursor", choices: ["true", "false"], bind: false, help: pui.Grid.helpTextGridProperties("false","When this property is set to true, the cursor is placed in the subfile record identified by the contents of the \"subfile record number\" property. The cursor is positioned at the first input-capable field in the subfile record." + (pui.viewdesigner ? "" : "  This property is equivalent to the SFLRCDNBR(CURSOR) keyword."),[],""), context: "dspf" },
      { name: "subfile end", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property is used to indicate that a subfile with a paging bar has loaded all of its records." + (pui.viewdesigner ? "" : "  It represents the SFLEND keyword."),[],""), context: "dspf" },
      { name: "subfile next changed", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property represents the SFLNXTCHG keyword, which forces the user to correct program-detected typing errors in subfile records. The program can cause a record to be changed so that a get-next-changed operation must read the record again.",[],""), context: "dspf", viewdesigner: false },
      { name: "cursor record number", readOnly: true, format: "number", hideFormatting: true, validDataTypes: ["zoned"], help: pui.Grid.helpTextGridProperties("bind","This property can be bound to a numeric field, which will return the relative record number of the record on which the cursor is located." + (pui.viewdesigner ? "" : "  It represents the SFLCSRRRN keyword."),[],""), context: "dspf" },
      { name: "cursor progression", choices: ["left to right", "top to bottom"], help: pui.Grid.helpTextGridProperties("left to right","This property determines the tab order for input elements within the subfile." + (pui.viewdesigner ? "" : "  It represents the SFLCSRPRG keyword."),[],""), context: "dspf" },
      { name: "subfile return rrn", readOnly: true, format: "number", hideFormatting: true, validDataTypes: ["zoned", "reference"], help: pui.Grid.helpTextGridProperties("bind","This property can be bound to a numeric field, which will return the relative record number of the top visible record within a grid." + (pui.viewdesigner ? "" : "  It represents the SFLSCROLL keyword."),[],""), context: "dspf" },
      { name: "subfile changed", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], help: pui.Grid.helpTextGridProperties("bind","Specifies a response indicator that is set on if the input data within the subfile is modified.",[],""), context: "dspf" },

      { name: "Message Subfile Settings", category: true, context: "dspf", viewdesigner: false },
      { name: "subfile message key", readOnly: true, hideFormatting: true, validDataTypes: ["char"], defaultDataLength: 4, help: pui.Grid.helpTextGridProperties("bind","This property specifies a field that is used to select messages from a program message queue for display. Your program places a message reference key in this field. The property represents the SFLMSGKEY keyword on a subfile record format.",[],""), context: "dspf", viewdesigner: false },
      { name: "subfile program message queue", readOnly: true, hideFormatting: true, validDataTypes: ["char"], help: pui.Grid.helpTextGridProperties("bind","This property specifies a field that contains the name of the program message queue used to build a message subfile. It represents the SFLPGMQ keyword on a subfile record format.",[],""), context: "dspf", viewdesigner: false },
      ...
      { name: "font family", choices: ["Arial", "Consolas", "Courier New", "Fantasy", "Georgia", "Monospace", "Tahoma", "Times New Roman", "Sans-Serif", "Serif", "Trebuchet MS", "Verdana", "Other..."], help: pui.Grid.helpTextGridProperties("css","The font face for the text inside the grid. To define a different font for each grid column, select <i>Other...</i> and specify a comma separated list of fonts.",["other", "font"],"") },
      { name: "font size", format: "px", choices: ["8px", "9px", "10px", "11px", "12px", "13px", "14px", "15px", "16px", "17px", "18px", "19px", "20px", "21px", "22px", "23px", "24px", "25px", "26px", "27px", "28px", "29px", "30px", "Other..."], help: pui.Grid.helpTextGridProperties("css","The size of the text inside the grid. To specify a different font size for each grid column, select <i>Other...</i> and specify a comma separated list of font sizes.",["other"],"") },
      { name: "font style", format: "italic / normal", choices: ["normal", "italic", "oblique", "Other..."], help: pui.Grid.helpTextGridProperties("css","The style of the font in the grid. To specify a different font style for each grid column, select <i>Other...</i> and specify a comma separated list of font styles.",["other"],"") },
      { name: "font variant", choices: ["normal", "small-caps", "Other..."], help: pui.Grid.helpTextGridProperties("css","Normal or <span style='font-variant:small-caps;'>small caps</span>. Small caps shows the text with all caps but same height as a lower case letter.",["other"],"") },
      ...
      { name: "letter spacing", format: "px", choices: ["normal", "-3px", "-2px", "-1px", "0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "10px", "11px", "12px", "13px", "14px", "15px", "16px", "17px", "18px", "19px", "20px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Spacing between each letter of a word. To specify a different value for each grid column, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },
      { name: "text align", choices: ["left", "right", "center", "justify", "Other..."], help: pui.Grid.helpTextGridProperties("css","Alignment of text inside cells of the grid element. To specify a different alignment option for each grid column, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },
      { name: "text decoration", format: "underline / none", choices: ["none", "underline", "overline", "line-through", "Other..."], help: pui.Grid.helpTextGridProperties("css","Decoration of the text inside the grid. To specify a different value for each grid column, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },
      { name: "text transform", choices: ["capitalize", "uppercase", "lowercase", "none", "Other..."], help: pui.Grid.helpTextGridProperties("css","Transforms the default formatting of the text inside the grid. To specify a different value for each grid column, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },
      { name: "word spacing", format: "px", choices: ["normal", "-3px", "-2px", "-1px", "0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "10px", "11px", "12px", "13px", "14px", "15px", "16px", "17px", "18px", "19px", "20px", "21px", "22px", "23px", "24px", "25px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Spacing between each word in the cells of the grid. To specify a different value for each grid column, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },

      { name: "Header", category: true },
      { name: "has header", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("true","Determines whether the grid has a header row.",[],"") },
      { name: "header height", help: pui.Grid.helpTextGridProperties("theme","Specifies the height of the header row. This can also be specified by dragging the grid's top border with the mouse.",[],""), bind: false, canBeRemoved: false },
      ...
      { name: "header font style", format: "bold / normal", choices: ["normal", "italic", "oblique", "Other..."], help: pui.Grid.helpTextGridProperties("css","Specifies the style of the font inside the grid header row. To specify a different font style for each grid column, select <i>Other...</i> and specify a comma separated list of font styles.",["other"],"") },
      ...
      { name: "header text align", choices: ["left", "right", "center", "justify", "Other..."], help: pui.Grid.helpTextGridProperties("css","Alignment of text inside the cells of the grid header row. To specify a different alignment option for each cell, select <i>Other...</i> and specify a comma separated list of values.",["other"],"") },
      { name: "header font color", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the color of the text inside the header row. To define a different color for each grid cell in the header row, specify a comma separated list of color values.",["color"],"") },
      { name: "header background", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the background color of the header row. To define a different color for each grid cell in the header row, specify a comma separated list of color values.",["background color"],"") },
      { name: "header image", type: "image", help: pui.Grid.helpTextGridProperties("css","Defines a repeating background image for the header row.",[],"") },
      { name: "column headings", type: "list", help: pui.Grid.helpTextGridProperties("placeholder","Specifies a comma separated list of heading text for each column of the grid.",[],""), translate: true },

      { name: "Colors", category: true },
      { name: "odd row font color", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the color of text inside the odd rows of the grid. To define a different color for each grid column, specify a comma separated list of color values.",["color","note"],"This only applies to text displayed in a database driven grid.") },
      { name: "odd row background", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the background color of the odd rows in the grid. To define a different color for each grid column, specify a comma separated list of color values.",["background color"],"") },
      { name: "even row font color", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the color of text inside the even rows of the grid. To define a different color for each grid column, specify a comma separated list of color values.",["color","note"],"This only applies to text displayed in a database driven grid.") },
      { name: "even row background", type: "color", help: pui.Grid.helpTextGridProperties("css","Defines the background color of the even rows in the grid. To define a different color for each grid column, specify a comma separated list of color values.",["background color"],"") },
      ...
      { name: "find option", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Presents an option to search grid data when the grid heading is right-clicked.",[],""), context: "dspf" },
      { name: "filter option", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Presents an option to filter grid data when the grid heading is right-clicked.",[],""), context: "dspf" },
      { name: "hide columns option", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Presents an option to hide and show columns for this grid when the grid heading is right-clicked. Defaults to false.",[],""), context: "dspf" },

      //Reset the  browser cache Data for a table
      { name: "reset option", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Presents an option to reset the persistent state for this grid when the grid heading is right-clicked.",[],""), context: "dspf" },
      { name: "export option", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Presents options to export grid data to Excel using the CSV and XLSX formats when the grid heading is right-clicked.",[],""), context: "dspf" },
      ...
      { name: "context menu id", help: pui.Grid.helpTextGridProperties("blank","Specifies the id of a Menu widget used to display a context menu when the user right-clicks a grid row.",[],""), hideFormatting: true, validDataTypes: ["char"] },

      { name: "Paging Bar", category: true, context: "dspf" },
      { name: "show paging controls", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","Displays links for navigating to the previous page and the next page of records.",[],"") },
      { name: "show page number", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","This property determines whether the page number should display within the paging bar.",[],""), context: "dspf" },
      { name: "initial page number", format: "number", hideFormatting: true, validDataTypes: ["zoned"], help: pui.Grid.helpTextGridProperties("1","Specifies the initial page number to use when the page number is displayed within the paging bar. If not specified, page number 1 is used.",[],""), context: "dspf" },
      ...
      { name: "page down condition", validDataTypes: ["indicator", "expression"], hideFormatting: true, readOnly: true, format: "true / false", type: "boolean", help: pui.Grid.helpTextGridProperties("bind","Determines if the next page link is enabled.",[],""), context: "dspf" },
      { name: "page down response", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], help: pui.Grid.helpTextGridProperties("bind","Specifies a response indicator that is returned to your program when the next page link is clicked.",[],""), context: "dspf" },
      { name: "page up condition", validDataTypes: ["indicator", "expression"], hideFormatting: true, readOnly: true, format: "true / false", type: "boolean", help: pui.Grid.helpTextGridProperties("bind","Determines if the previous page link is enabled.",[],""), context: "dspf" },
      { name: "page up response", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], help: pui.Grid.helpTextGridProperties("bind","Specifies a response indicator that is returned to your program when the previous page link is clicked.",[],""), context: "dspf" },
      ...
      { name: "xlsx export pics", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","Include pictures in the XLSX Export. This option only works for Load-All subfiles.",[],""), context: "dspf" },
      { name: "export file name", help: pui.Grid.helpTextGridProperties("blank","Defines the name of the download file used to export grid data to CSV or XLSX formats. The .xlsx or .csv extension is automatically appended to the name. If omitted, the record format name is used." + ((context == "genie" && !pui.usingGenieHandler) ? " <br /><b>Note:</b> In 5250 mode, this option only works with SQL-driven subfiles." : ""),[],""), translate: true },
      ...
      { name: "expanded", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","Determines if the rows are first displayed in expanded (also known as folded) mode." + (pui.viewdesigner ? "" : "  This property is similar to the SFLFOLD keyword."),[],""), context: "dspf" },
      { name: "collapsed", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","Determines if the rows are first displayed in collapsed (also known as truncated) mode." + (pui.viewdesigner ? "" : "  This property is similar to the SFLDROP keyword."),[],""), context: "dspf" },
      { name: "return mode", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["char", "indicator"], help: pui.Grid.helpTextGridProperties("bind","This property can be bound to a field that will provide an indication of whether the grid rows were in expanded (also known as folded) mode or in collapsed (also known as truncated) mode on input." + (pui.viewdesigner ? "" : "  It represents the SFLMODE keyword. The bound field will contain a value of 0 if the grid rows are in expanded mode and a value of 1 if the grid rows are in collapsed mode."),[],""), context: "dspf" },
      { name: "single row zoom", choices: ["true", "false"], hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.Grid.helpTextGridProperties("false","Determines if a zoom icon is shown on collapsed rows. Once the user clicks the icon, the row is expanded. All other rows remain collapsed.",[],""), context: "dspf" },

      { name: "Grid Data", category: true },
      { name: "database file", type: "file", uppercase: true, help: pui.Grid.helpTextGridProperties("blank","Database file to use for a grid that is tied directly to a database. You can specify a 'database file' or 'library/database file'. If library is omitted, the session's library list is used.",[],"") },
      { name: "database fields", type: "field", multiple: true, uppercase: true, help: pui.Grid.helpTextGridProperties("blank", "A set of database field names to use to retrieve the data for a database-driven grid. The field names should be comma separated.", [], ""), descriptionsHandler: function (descriptions) {
      ...
      { name: "selection criteria", type: "long", help: pui.Grid.helpTextGridProperties("blank","Optional expression identifying which records should be retrieved from the database file.",[],"") },
      { name: "order by", type: "field", multiple: true, uppercase: true, help: pui.Grid.helpTextGridProperties("blank","Optional expression identifying which fields determine the order of the records retrieved from the database file.",[],"") },
      { name: "custom sql", type: "long", help: pui.Grid.helpTextGridProperties("blank","Specifies a sql statement to use to retrieve the records for a database-driven grid.",[],""), 
      ...
      { name: "parameter value", type: "long", secLevel: 1, multOccur: true, help: pui.Grid.helpTextGridProperties("blank","Value for parameter marker in \"selection criteria\" or \"custom sql\" property. Parameter markers are specified using a question mark. Profound UI will accept values from the client for any parameter marker values which are not bound to program fields. Parameter markers are numbered in order of occurence, from left to right. To specify multiple parameter marker values, right-click the property and select Add Another Parameter Value.",[],"") },
      { name: "data url", type: "long", help: pui.Grid.helpTextGridProperties("blank","Sets the url to a Web service that returns JSON data for a database-driven grid.",[],"") },
      { name: "data transform function", type: "long", help: pui.Grid.helpTextGridProperties("blank","The name of a JavaScript function to be called to process the results of the \"data url\" program. This can be used to transform data from the program into the format expected by the grid widget.",[],"") },

      { name: "Grid Data from Screen", category: true, context: "genie-nohandler" },
      { name: "starting row", help: pui.Grid.helpTextGridProperties("blank","Specifies the starting subfile row for retrieving data from the screen.",[],""), context: "genie-nohandler" },
      { name: "ending row", help: pui.Grid.helpTextGridProperties("blank","Specifies the ending subfile row for retrieving data from the screen.",[],""), context: "genie-nohandler" },
      { name: "data columns", type: "list", help: pui.Grid.helpTextGridProperties("blank","Specifies a comma separated list of column numbers for retrieving data from the screen.",[],""), context: "genie-nohandler" },

      { name: "Position", category: true },
      { name: "left", format: "px", help: pui.Grid.helpTextGridProperties("position","Represents the x-coordinate of the current element.",[],""), canBeRemoved: false },
      { name: "top", format: "px", help: pui.Grid.helpTextGridProperties("position","Represents the y-coordinate of the current element.",[],""), canBeRemoved: false },
      { name: "right", format: "px", help: pui.Grid.helpTextGridProperties("position","Represents the x-coordinate of the current element.",[],""), canBeRemoved: false },
      { name: "bottom", format: "px", help: pui.Grid.helpTextGridProperties("position","Represents the y-coordinate of the current element.",[],""), canBeRemoved: false },
      { name: "height", help: pui.Grid.helpTextGridProperties("css","Height of the grid.",[],""), bind: false, canBeRemoved: false },
      { name: "width", help: pui.Grid.helpTextGridProperties("css","Width of the grid.",[],""), bind: false, canBeRemoved: false },
      { name: "expand to layout", choices: ["true", "false"], help: pui.Grid.helpTextGridProperties("false","If set to true, the grid will automatically expand to the full size of a layout container.",[],""), context: "dspf", bind: false },
      { name: "z index", format: "number", help: pui.Grid.helpTextGridProperties("css","The stacking order of the current element, expressed as an integer value. The element with the higher z index will overlay lesser elements.",[],"") },
      { name: "locked in place", choices: ["true", "false"], help: pui.Grid.helpTextGridProperties("false","If set to true, the grid cannot be moved or sized in the Visual Designer.",[],""), bind: false },

      { name: "Drag and Drop", category: true, context: "dspf" },
      { name: "allow drag", choices: ["true", "false"], type: "boolean", validDataTypes: ["indicator", "expression"], hideFormatting: true, help: pui.Grid.helpTextGridProperties("false","This property determines if rows within the grid can be drag and dropped.",[],""), context: "dspf" },
      { name: "ondragstart", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user first starts to drag a row within the grid. Information about the drag and drop operation is provided using the global pui.dragDropInfo object.",[],""), context: "dspf" },
      { name: "drop targets", type: "list", help: pui.Grid.helpTextGridProperties("blank","Specifies a list of target element id's, which indentify where the row can be dropped.",[],""), context: "dspf" },
      { name: "ondragenter", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user drags a row over a valid drop target. Information about the drag and drop operation is provided using the global pui.dragDropInfo object.",[],""), context: "dspf" },
      { name: "ondragleave", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user moves a row out of a valid drop target during a drag operation. Information about the drag and drop operation is provided using the global pui.dragDropInfo object.",[],""), context: "dspf" },
      { name: "ondrop", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the mouse is released during a drag and drop operation. Information about the drag and drop operation is provided using the global pui.dragDropInfo object.",[],""), context: "dspf" },

      { name: "Tabs", category: true },
      { name: "parent tab panel", help: pui.Grid.helpTextGridProperties("blank","This property specifies the id of the Tab Panel to which this element belongs. The property is set automatically when you drag and drop the element onto a Tab Panel.",[],""), bind: false },
      { name: "parent tab", help: pui.Grid.helpTextGridProperties("blank","This property specifies the tab index of the specific tab to which this element belongs. Each tab within a Tab Panel is identified by a sequential index, starting with 0 for the first tab, 1 for the second tab, and so on. The property is set automatically when you drag and drop the element onto a Tab Panel.",[],""), bind: false },
      { name: "parent field set", help: pui.Grid.helpTextGridProperties("blank","This property specifies the if of the Field Set Panel to which this element belongs. The property is set automatically when you drag and drop the element onto a Field Set Panel.",[],""), bind: false },

      { name: "Borders", category: true },
      { name: "border color", type: "color", help: pui.Grid.helpTextGridProperties("css","The color of the grid's outer borders and inner separators.",[],"") },
      { name: "border width", format: "px", choices: ["0px", "1px", "2px", "3px", "4px", "5px", "Other..."], help: pui.Grid.helpTextGridProperties("css","The thickness of the grid's outer borders and inner separators.",["other"],"") },

      { name: "Padding", category: true },
      { name: "padding bottom", format: "px", choices: ["0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Sets the distance between the bottom edge of a grid cell and the cell's content.",["other"],"") },
      { name: "padding left", format: "px", choices: ["0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Sets the distance between the left edge of a grid cell and the cell's content.",["other"],"") },
      { name: "padding right", format: "px", choices: ["0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Sets the distance between the right edge of a grid cell and the cell's content.",["other"],"") },
      { name: "padding top", format: "px", choices: ["0px", "1px", "2px", "3px", "4px", "5px", "6px", "7px", "8px", "9px", "Other..."], help: pui.Grid.helpTextGridProperties("css","Sets the distance between the top edge of a grid cell and the cell's content.",["other"],"") },

      { name: "Misc", category: true },
      { name: "css class", type: "cssClass", multOccur: (context == "dspf" ? true : false), attribute: "class", help: pui.Grid.helpTextGridProperties("widget","Defines a custom cascading style sheet class to assign to the element." + (context == "dspf" ? "  To specify multiple classes, right-click the property and select Add Another CSS Class." : ""),[],"") },
      { name: "tool tip", type: "long", help: pui.Grid.helpTextGridProperties("blank","Defines the text to appear in a tool tip when the user hovers the mouse over this element.",[],""), translate: true },
      { name: "user defined data", multOccur: true, help: pui.Grid.helpTextGridProperties("blank","Specifies user-defined general purpose data associated with the widget. To provide multiple user defined data values, right-click the property and select Add Another User Defined Value.",[],"") },
      { name: "visibility", format: "visible / hidden", choices: ["hidden", "visible"], help: pui.Grid.helpTextGridProperties("css","Determines whether the element is visible or hidden.",[],"") },

      { name: "Events", category: true },
      { name: "ondbload", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when database data is loaded for a database-driven widget. An object named <b>response</b> will be defined that contains:<ul><li><b>success</b> - boolean true/false</li><li><b>id</b> - the widget id</li><li><b>error</b> - an object with \"id\", \"text\" and \"text2\" fields containing the error.</li></ul>",[],"") },
      { name: "onfilterchange", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the filter has changed.",[],""), bind: false, context: "dspf" },
      { name: "onrowclick", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when a row within the grid is clicked. The script can determine the row number using the <b>row</b> variable.",[],""), bind: false },
      { name: "onrowdblclick", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when a row within the grid is double-clicked. The script can determine the row number using the <b>row</b> variable.",[],""), bind: false },
      { name: "onrowmouseover", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the mouse is moved over a row within the grid. The script can determine the row number using the <b>row</b> variable.",[],""), bind: false },
      { name: "onrowmouseout", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the mouse is moved off of a row within the grid. The script can determine the row number using the <b>row</b> variable.",[],""), bind: false },
      { name: "onpagedown", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user pages down using the grid's scrollbar or the grid's paging bar. To prevent the grid's default paging action, the script must evaluate to <i>false</i>.",[],""), bind: false },
      { name: "onpageup", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user pages up using the grid's scrollbar or the grid's paging bar. To prevent the grid's default paging action, the script must evaluate to <i>false</i>.",[],""), bind: false },
      { name: "onscroll", type: "js", help: pui.Grid.helpTextGridProperties("blank","Initiates a client-side script when the user scrolls using the grid's scrollbar. The <b>row</b> variable in the script provides the top row of the grid.",[],""), bind: false }
    ];
