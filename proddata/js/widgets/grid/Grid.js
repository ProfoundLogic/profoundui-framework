...
pui.Grid = function () {
  ...
  this.getPropertiesModel = function () {
    var model = [{ name: "Identification", category: true },
      ...
      { name: "page down response", wf: true, format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], help: pui.helpTextProperties("bind","Specifies a response indicator that is returned to your program when the next page link is clicked."), context: "dspf" },
      ...
      { name: "page up response", wf: true, format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], help: pui.helpTextProperties("bind","Specifies a response indicator that is returned to your program when the previous page link is clicked."), context: "dspf" },
      ...
      { name: "onrowclick", wf: true, type: "js", help: pui.helpTextProperties("blank","Initiates a client-side script when a row within the grid is clicked. The script can determine the row number using the <b>row</b> variable."), bind: false },
      { name: "onrowdblclick", wf: true, type: "js", help: pui.helpTextProperties("blank","Initiates a client-side script when a row within the grid is double-clicked. The script can determine the row number using the <b>row</b> variable."), bind: false },
      ...
      { name: "onpagedown", wf: true, type: "js", help: pui.helpTextProperties("blank","Initiates a client-side script when the user pages down using the grid's scrollbar or the grid's paging bar. To prevent the grid's default paging action, the script must evaluate to <i>false</i>."), bind: false },
      { name: "onpageup", wf: true, type: "js", help: pui.helpTextProperties("blank","Initiates a client-side script when the user pages up using the grid's scrollbar or the grid's paging bar. To prevent the grid's default paging action, the script must evaluate to <i>false</i>."), bind: false },
