...
pui.BaseGrid.prototype.getPropertiesModel = function(){
  ...
  // 1 = help description should always warn/hide; 2 = warn/hide only for nodeDesigner.
    var model = [{ name: "Identification", category: true },
      ...
      { name: "subfile changed", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], helpDefault: "bind", help: "Specifies a response indicator that is set on if the input data within the subfile is modified.", context: "dspf" },
      ...
      { name: "page down response", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], helpDefault: "bind", help: "Specifies a response indicator that is returned to your program when the next page link is clicked.", context: "dspf" },
      ...
      { name: "page up response", format: "1 / 0", readOnly: true, hideFormatting: true, validDataTypes: ["indicator"], helpDefault: "bind", help: "Specifies a response indicator that is returned to your program when the previous page link is clicked.", context: "dspf" },
      ...
      { name: "right", format: "px", helpDefault: "position", help: "Represents the x-coordinate of the current element.", canBeRemoved: false },
      { name: "bottom", format: "px", helpDefault: "position", help: "Represents the y-coordinate of the current element.", canBeRemoved: false },
