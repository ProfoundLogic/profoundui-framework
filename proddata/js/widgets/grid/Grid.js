...
pui.Grid = function() {
  ...
  this.getPropertiesModel = function() {
    var model = [
      ...
      { name: "initial page number", format: "number", help: "Specifies the initial page number to use when the page number is displayed within the paging bar.  If not specified, page number 1 is used.", context: "dspf" },
