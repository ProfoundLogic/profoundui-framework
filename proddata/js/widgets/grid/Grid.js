...
pui.Grid = function () {
  ...
  this.getPropertiesModel = function () {
    var model = [{ name: "Identification", category: true },
      ...
      { name: "record format name", displayName: (pui.nodedesigner ? "name" : undefined), help: me.helpTextGridProperties("blank","Specifies the record format that is used to access this grid from server code.",[],""), maxLength: (pui.viewdesigner|| pui.nodedesigner ? null : 10), bind: false, context: "dspf", canBeRemoved: false },
