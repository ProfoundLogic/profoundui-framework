...
var en_UK = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      ...
      dictMsg["upload cancelled"] = "Upload cancelled.";
    ...
    case "runtimeText":
      ...
      dictMsg["multi filter text"] = "Filter by Value";
      dictMsg["filter multiple"] = "Select Data to Filter";
      dictMsg["filter check"] = "Filter";
      dictMsg["filter data"] = "Data";
      ...
      dictMsg["favorites"] = "Favourites";
      dictMsg["type query press en"] = "Type query, press Enter.";
      dictMsg["add to favorites"] = "Add to Favourites";
      dictMsg["rmv from favorites"] = "Remove from Favourites";
      ...
      dictMsg["show fav sys"] = "Show Favourites system";
      dictMsg["show fav sys hlp"] = "Uncheck to disable the Favourites system.";
      dictMsg["show fav start"] = "Show Favourites on startup";
      dictMsg["show fav start hlp"] = "If checked, the Favourites panel is shown on startup. Otherwise the Navigation panel will be shown (default). This option will only be available if Favourites system is enabled.";
