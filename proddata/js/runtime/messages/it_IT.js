...
var it_IT = function(dict) {
    ...
    switch (dict) {
        ...
        case "runtimeMsg":
            ...
            dictMsg["cannot find col"]              = "Colonna non trovata.";  //TODO - correct ??
            ...
            dictMsg["permission settings"]          = "Impostazioni di autorizzazione";
            ...
            dictMsg["msg del group"]                = "Sei sicuro di voler eliminare il gruppo \"&1\"?<br /><br />Cancellando un gruppo verranno eliminati anche tutti i suoi sottogruppi e gli utenti associati.<br /><br />Are you sure you want to continue?";
        ...
        case "runtimeText":
            ...
            dictMsg["about atrium msg"]             = "Versione: " + window["pui"]["baseVersion"] + ", Fix Pack " + window["pui"]["fixPackVersion"] + "<br /><br />"
            ...
            dictMsg["search results"]               = "Cerca risultati";
            ...
            dictMsg["screen"]                       = "Schermata";
            dictMsg["screens"]                      = "Schermate";
            dictMsg["macro"]                        = "Macro";
            dictMsg["macros"]                       = "Macro";
            dictMsg["screen id"]                    = "Identificatore della schermata";
            dictMsg["screen ids"]                   = "Identificatori della schermata";
            ...
            dictMsg["action"]                       = "Azione";
            dictMsg["actions"]                      = "Azioni";
            dictMsg["detect once"]                  = "Detect Once"; //TODO ? I have a question out to confirm if this is correct or overlooked in list
            dictMsg["delete screen"]                = "Elimina schermata";
            dictMsg["genie macros"]                 = "Macro di Genie";
            dictMsg["screen name"]                  = "Nome della schermata";
            dictMsg["identifier"]                   = "Identificatore";
            dictMsg["identifiers"]                  = "Identificatori";
            ...
            dictMsg["membership"]                   = "Gruppi di appartenenza";
