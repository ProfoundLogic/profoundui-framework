...
var nl_NL = function(dict) {
  ...
  switch (dict) {
    ...
    case "runtimeText":
      ...
      dictMsg["multi filter text"] = "Filter op waarde";
      dictMsg["filter multiple"] = "Selecteer de gegevens om te filteren";
      dictMsg["filter check"] = "Filter";
      dictMsg["filter data"] = "Gegevens";
      dictMsg["find text"] = "Zoek";
      dictMsg["reset data"] = "Reset";
      dictMsg["remove filters text"] = "Verwijder alle filters";
      dictMsg["displayed columns"] = "Getoonde Kolommen";
      ...
      dictMsg["sort..."] = "Sort...";
      dictMsg["sort"] = "Sorteren";
      dictMsg["sort multiple"] = "Sorteer Meerdere Kolommen";
      dictMsg["column"] = "Kolom";
      dictMsg["direction"] = "Richting";
      dictMsg["order"] = "Volgorde";
      dictMsg["row"] = "rij";
      dictMsg["rows"] = "rijen";
      dictMsg["page"] = "Pagina";
      ...
      dictMsg["maximize"] = "Maximaliseren";
      dictMsg["restore"] = "Terugzetten";
