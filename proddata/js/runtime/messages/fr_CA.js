...
var fr_CA = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      dictMsg["closeMessage"] = "Votre session sera fermée.";
      dictMsg["no connection message"] = "Impossible d'accéder le serveur.  Veuillez vérifier votre connexion et réessayer.";
      dictMsg["upload file limit"] = "La limite de &1 fichier(s) est dépassée.";
      dictMsg["upload size limit"] = "La limite de &1MB par fichier est dépassée.";
      dictMsg["upload no files"] = "Aucun fichier sélectionné.";
      dictMsg["upload duplicate file"] = "Doublon(s) dans les fichiers sélectionnés.";
      dictMsg["upload file exists"] = "Un ou plusieurs fichier(s) existe déjà sur le système.";
      dictMsg["upload prevented"] = "L'opération est bloquée par le programme de sortie.";
      dictMsg["upload input limit"] = "L'entrée de données dépasse la limite.";
      dictMsg["upload no session"] = "Il n'y a aucune connection à une session valide.";
      dictMsg["upload timeout"] = "La transaction a expirée.";
      dictMsg["upload invalid response"] = "La réponse du serveur est manquante ou invalide."; // Also used in Atrium for Ajax error.
      dictMsg["upload cancelled"] = "Téléversement annulé";
      dictMsg["close browser text"] = "Veuillez fermer votre navigateur pour compléter le processus de déconnection.";
      dictMsg["session ended text"] = "Votre session s'est terminée.";
      dictMsg["outside ucs2"] = "Caractères non-permis parmi les valeurs permises dans le UCS-2.";
      ...
      dictMsg["phone too long"] = "Le numéro de téléphone est trop long. (Maximum: &1 caractères)";
      dictMsg["ssno too long"] = "Le numéro d'assurance sociale est trop long. (Maximum: &1 caractères)";
      dictMsg["invalid custom val"] = "La fonction de validation est invalide.";
      dictMsg["error custom val"] = "Erreur dans la fonction de validation.";
      dictMsg["ME"] = "Le champ est obligatoire.";
      dictMsg["MF"] = "Chaque caractère doit être remplit pour ce champ.";
      dictMsg["required"] = "Le champ doit être remplit.";
      dictMsg["file required"] = "Au moins un fichier doit être choisi.";
      dictMsg["signature overflow"] = "La grosseur de la signature dépasse l'espace de stockage permis. Veuillez effacer la signature et réessayer.";
      dictMsg["validValues"] = "La valeur entrée est invalide. Les valeurs valides sont: ";
      dictMsg["upload invalid type"] = "Un ou plusieurs fichiers sont de type invalide.";
      dictMsg["invalid email"] = "L'adresse courriel est invalide.";
      dictMsg["session timed out"] = "Votre session est expirée.";
      ...
      dictMsg["invalid range"] = "La valeur doit se situer entre &1 et &2";
      dictMsg["unmonitored exception"] = "Le programme a rencontré une erreur non controlée. Veuillez contacter l'administrateur du système.";
      ...
      dictMsg["keyboard input inhibited"] = "Saisie interdite dans ce champ.";
      ...
      dictMsg["cannot move screen"] = "Impossible de déplacer la Macro Écran";
      dictMsg["ready to add"] = "(Prêt à ajouter des actions sur cet écran)";
      dictMsg["duplicate actions"] = "Action(s) en double trouvée(s) pour cette ligne/colonne, des résultats imprévisibles peuvent se produire. Veuillez consulter les actions et supprimer les doublons.";

      break;

    case "runtimeText":
      dictMsg["upload select text"] = "Sélection de fichiers";
      dictMsg["upload clear text"] = "Effacer";
      dictMsg["upload remove text"] = "Supprimer";
      dictMsg["upload upload text"] = "Téléversement";
      ...
      dictMsg["multi filter text"] = "Filtrer par valeur";
      dictMsg["filter multiple"] = "Sélectionner la donnée à filtrer";
      dictMsg["filter check"] = "Filtrer";
      dictMsg["filter data"] = "Donnée";
      dictMsg["find text"] = "Trouver";
      dictMsg["reset data"] = "Réinitialiser";
      dictMsg["remove filters text"] = "Enlever les filtres";
      dictMsg["displayed columns"] = "Colonnes affichées";
      dictMsg["next link text"] = "Suivante";
      dictMsg["previous link text"] = "Précédente";
      dictMsg["sort ascending text"] = "Tri ascendant";
      dictMsg["sort descending text"] = "Tri descendant";
      dictMsg["sort..."] = "Trier...";
      dictMsg["sort"] = "Tri";
      dictMsg["sort multiple"] = "Trier Plusieurs Colonnes";
      dictMsg["column"] = "Colonne";
      dictMsg["direction"] = "Sens";
      dictMsg["order"] = "Ordre";
      dictMsg["row"] = "rangée";
      dictMsg["rows"] = "rangées";
      dictMsg["page"] = "Page";
      dictMsg["collapseAll"] = "Réduire tout";
      dictMsg["expandAll"] = "Ouvrir tout";
      dictMsg["user"] = "Utilisateur";
      dictMsg["password"] = "Mot de passe";
      dictMsg["sign on"] = "Connection";
      ...
      dictMsg["message id"] = "Identifiant de message";
      ...
      dictMsg["repeat new password"] = "Répéter le mot de passe";
      dictMsg["submit"] = "Soumettre";
      dictMsg["exit"] = "Quitter";
      dictMsg["warning"] = "Avertissement";
      dictMsg["change password"] = "Changer mot de passe";
      ...
      dictMsg["launcher command"] = "Commande Launcher";
