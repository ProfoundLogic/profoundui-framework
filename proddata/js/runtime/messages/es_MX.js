...
var es_MX = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      dictMsg["closeMessage"] = "Esto finalizará su sesión.";
      dictMsg["no connection message"] = "No se puede acceder al servidor. Verifique su conexión y trate de nuevo.";
      ...
      dictMsg["upload duplicate file"] = "Archivos duplicados seleccionados.";
      dictMsg["upload file exists"] = "Uno a más archivos ya existen en el sistema de archivos.";
      dictMsg["upload prevented"] = "Operación evitada por programa de salida.";
      dictMsg["upload input limit"] = "Límite de tamaño total de entrada excedido";
      dictMsg["upload no session"] = "No está conectado en una sesión válida.";
      dictMsg["upload timeout"] = "La transacción excedió el límite de tiempo.";
      dictMsg["upload invalid response"] = "La respuesta del servidor es inválida o no se encuentra."; // Also used in Atrium for Ajax error.
      dictMsg["upload cancelled"] = "Carga cancelada.";
      dictMsg["close browser text"] = "Para completar el proceso de cierre de sesión, favor cerrar la ventana de su navegador.";
      dictMsg["session ended text"] = "Su sesión ha terminado.";
      dictMsg["outside ucs2"] = "Los caracteres están fuera del rango del UCS-2.";
      dictMsg["invalid number"] = "&1 no es un número válido.";
      dictMsg["invalid length"] = "&1 tiene un largo de datos, o posición decimal incorrectos.";
      dictMsg["invalid decimal"] = "&1 tiene demasiadas posiciones decimales. (Máx.: &2)";
      dictMsg["invalid choice"] = '"&1" es inválido. Las opciones válidas son: "&2" o "&3".';
      dictMsg["invalid date"] = '"&1" no es una fecha válida. Ejemplo del formato : &2';
      dictMsg["invalid time"] = '"&1" no es una la hora válida. Ejemplo del formato : &2';
      dictMsg["invalid time stamp"] = '"&1" no es una fecha-hora válida. Ejemplo del formato: &2';
      dictMsg["invalid percent"] = "&1 no es un decimal válido.";
      dictMsg["invalid digits"] = '"&1"contiene demasiados dígitos. Máx.: &2';
      dictMsg["exceeds whole"] = '"&1" excede el número máximo de dígitos para la porción del número entero (&2 dígitos).';
      dictMsg["exceeds decimal"] = '"&1" excede el número máximo de dígitos para la porción decimal (&2 dígitos).';
      dictMsg["zip too long"] = "Código de área es demasiado largo. (Máximo: &1 dígitos)";
      dictMsg["phone too long"] = "Número de Teléfono es demasiado largo. (Máximo: &1 dígitos)";
      dictMsg["ssno too long"] = "Número de Seguro Social muy largo. (Máximo: &1 dígitos)";
      dictMsg["invalid custom val"] = "Función de validación personalizada es inválida.";
      dictMsg["error custom val"] = "Error en la validación de la función personalizada.";
      dictMsg["ME"] = "Campo de entrada obligatorio. Debe ingresar los datos.";
      dictMsg["MF"] = "Campo de relleno obligatorio. Debe rellenar el cuadro de entrada completamente.";
      dictMsg["required"] = "El valor no puede ser blanco. Este campo es requerido.";
      dictMsg["file required"] = "Debe seleccionar al menos un archivo.";
      dictMsg["signature overflow"] = "El tamaño del dibujo de la firma excede el número máximo de bytes disponible para almacenar la firma. Por favor borre el área de firma y trate de nuevo.";
      dictMsg["validValues"] = "El valor ingresado es invalido. Los valores válidos son: ";
      ...
      dictMsg["keyboard input inhibited"] = "No se permite entrada de teclado en este campo.";
      ...
      dictMsg["cannot move screen"] = "No es posible mover la pantalla de Macro";
      dictMsg["ready to add"] = "(Listo para adicionar acciones en esta pantalla)";
      dictMsg["duplicate actions"] = "Se encontraron acciones duplicadas para esta fila/columna, pueden ocurrir resultados impredecibles. Por favor revise las acciones y borre las duplicadas.";

      break;

    case "runtimeText":
      dictMsg["upload select text"] = "Seleccionar Archivos";
      dictMsg["upload clear text"] = "Limpiar";
      dictMsg["upload remove text"] = "Eliminar";
      dictMsg["upload upload text"] = "Subir";
      ...
      dictMsg["excel export text"] = "Exportar a Excel"; // Replaces "csv export text".
      dictMsg["export to x"] = "Exportar a &1";
      dictMsg["filter text"] = "Filtrar";
      dictMsg["multi filter text"] = "Filtrar por Valor";
      dictMsg["filter multiple"] = "Seleccione Fecha para Filtrar";
      dictMsg["filter check"] = "Filtrar";
      dictMsg["filter data"] = "Fecha";
      ...
      dictMsg["sort..."] = "Ordenar...";
      dictMsg["sort"] = "Ordenar";
      dictMsg["sort multiple"] = "Ordenar Múltiples Columnas";
      dictMsg["column"] = "Columna";
      dictMsg["direction"] = "Dirección";
      dictMsg["order"] = "Orden";
      dictMsg["row"] = "fila";
      dictMsg["rows"] = "filas";
      dictMsg["page"] = "Página";
      ...
      dictMsg["message id"] = "Identificación de mensaje";
      dictMsg["ctlr job"] = "Trabajo Controlador";
      dictMsg["app job"] = "Trabajo de Aplicación";
      dictMsg["joblog download"] = "Descargar Job Logs";
