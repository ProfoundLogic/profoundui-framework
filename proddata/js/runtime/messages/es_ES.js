...
var es_ES = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      dictMsg["closeMessage"] = "Se cerrará su sesión.";
      dictMsg["no connection message"] = "No es posible establecer conexión al servidor. Verifique la conexión e inténtelo de nuevo.";
      ...
      dictMsg["upload duplicate file"] = "Archivos seleccionados duplicados.";
      dictMsg["upload file exists"] = "Uno o más archivos ya existen en el sistema de archivos.";
      ...
      dictMsg["upload timeout"] = "El tiempo límite para la transacción fue excedido.";
      dictMsg["upload invalid response"] = "No hay respuesta del servidor o es inválida."; // Also used in Atrium for Ajax error.
      dictMsg["upload cancelled"] = "Carga cancelada.";
      dictMsg["close browser text"] = "Para terminar el proceso de cierre de la sesión, por favor cierre el navegador.";
      ...
      dictMsg["invalid length"] = "&1 tiene longitud o número de decimales incorrectos.";
      dictMsg["invalid decimal"] = "&1 tiene excesivas números decimales. (max: &2)";
      ...
      dictMsg["invalid digits"] = '"&1" contiene demasiados dígitos. Max: &2';
      ...
      dictMsg["error custom val"] = "Error en la validación de función custom.";
      dictMsg["ME"] = "Campo de entrada obligatorio. Debe incorporar datos.";
      dictMsg["MF"] = "Campo de entrada total obligatoria. Debe rellenar el campo de texto totalmente.";
      ...
      dictMsg["signature overflow"] = "La imagen de la firma excede el número máximo de los bytes disponibles para su almacenaje. Por favor borre el campo de la firma e inténtelo de nuevo.";
      ...
      dictMsg["unmonitored exception"] = "Este programa ha encontrado algunas excepciones no monitorizadas. Por Favor, contacte con el administrador del sistema para su ayuda.";
      ...
      dictMsg["cannot rmv last col"] = "No se puede eliminar la última columna.";
      dictMsg["cannot find col"] = "No se puede encontrar el id de columna especificado.";
      dictMsg["subfile deletion"] = "Está seguro que desea borrar el subarchivo ?";
      ...
      dictMsg["unable to add x"] = "No es posible agregar &1.";
      ...
      dictMsg["close browser text AT"] = "Los cambios no salvados en las sesiones se perderán.";
      ...
      dictMsg["confirm delete"] = "Confirme borrado";
      ...
      dictMsg["adding x"] = "Agregando &1...";
      dictMsg["deleting x"] = "Borrando &1 ...";
      dictMsg["reassigning x"] = "Reasignando &1...";
      dictMsg["loading"] = "Cargando...";
      dictMsg["saving"] = "Salvando...";
      dictMsg["x added"] = "&1 agregado.";
      dictMsg["x deleted"] = "&1 borrado.";
      dictMsg["x reassigned"] = "&1 reasignado.";
      dictMsg["x updated"] = "&1 actualizado.";
      dictMsg["x saved"] = "&1 salvado.";
      dictMsg["msg del group"] = "Está seguro que desea borrar el grupo \"&1\" ?<br /><br />La eliminación de grupos también elimina cualquier subgrupo y cualquier usuario asociado.<br /><br />Está seguro que desea continuar ?";
      ...
      dictMsg["typeselect macro name"] = "Teclee o seleccione el nombre de macro...";
      ...
      dictMsg["type or sel home page"] = "Teclee o seleccione la página de inicio...";
    ...
    case "runtimeText":
      ...
      dictMsg["displayed columns"] = "Columnas Mostradas";
      ...
      dictMsg["error stack download"] = "Descargar Pila de Errores";
      dictMsg["maximize"] = "Maximizar";
      dictMsg["restore"] = "Restaurar";
      ...
      dictMsg["type query press en"] = "Teclee la consulta, presione Enter.";
      dictMsg["add to favorites"] = "Agregar a Favoritos";
      ...
      dictMsg["detect always"] = "Detectar siempre";
      ...
      dictMsg["home pages"] = "Páginas de inicio";
      ...
      dictMsg["add usrgrp perm"] = "Agregar permisos de usuario/grupo";
      ...
      dictMsg["save"] = "Salvar";
      dictMsg["add usr to supp grp"] = "Agregar usuario o grupo suplementario";
      ...
      dictMsg["browser title"] = "Título del navegador";
      ...
      dictMsg["navi pnl title"] = "Título del panel de navegación";
