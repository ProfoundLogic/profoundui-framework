...
var de_DE = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      ...
      dictMsg["keyboard input inhibited"] = "Tastatureingabe ist in diesem Feld nicht erlaubt.";
      dictMsg["pccommand error"] = "Der Versuch STRPCCMD zu verarbeiten ist fehlgeschlagen. Bitte stellen Sie sicher, " +
            "dass der Profound UI PC Listener auf dieser Maschine läuft und richtig konfiguriert ist. Prüfen Sie die Browserkonsole" +
            " für weitere Informationen. (Für gewöhnlich: Strg+Shift+I) ";
      dictMsg["no data"] = "Keine Daten";
      ...
      dictMsg["unable to load x"] = "&1 kann nicht geladen werden.";
      dictMsg["unable to add x"] = "&1 kann nicht hinzugefügt werden.";
      dictMsg["unable to rename x"] = "&1 kann nicht umbenannt werden.";
      dictMsg["unable to delete x"] = "&1 kann nicht gelöscht werden.";
      dictMsg["unable to update x"] = "&1 kann nicht aktualisiert werden.";
      dictMsg["unable to reassn x"] = "&1 kann nicht zugewiesen werden.";
      ...
      dictMsg["cannot move screen"] = "Macro Bildschirm nicht verschiebbar";
      dictMsg["ready to add"] = "(Bereit Aktion(en) hinzuzufügen)";
      dictMsg["duplicate actions"] = "Identische Aktion(en) für diese Reihe/Spalte gefunden, unvorhersehbares Verhalten möglich. Bitte Aktionen überprüfen und Duplikate löschen.";
    ...
    case "runtimeText":
      ...
      dictMsg["upload upload text"] = "Hochladen";
      ...
      dictMsg["multi filter text"] = "nach Wert filtern";
      dictMsg["filter multiple"] = "Daten zum Filtern auswählen";
      dictMsg["filter check"] = "Filter";
      dictMsg["filter data"] = "Daten";
      dictMsg["find text"] = "Finden";
      dictMsg["reset data"] = "Zurücksetzen";
      dictMsg["remove filters text"] = "Alle Filter entfernen";
      dictMsg["displayed columns"] = "Angezeigte Spalten";
      dictMsg["next link text"] = "Nächste";
      dictMsg["previous link text"] = "Vorherige";
      dictMsg["sort ascending text"] = "Sortierung aufsteigend";
      dictMsg["sort descending text"] = "Sortierung absteigend";
      dictMsg["sort..."] = "Sortiere...";
      dictMsg["sort"] = "Sortiere";
      dictMsg["sort multiple"] = "Sortiere mehrere Spalten";
      dictMsg["column"] = "Spalte";
      dictMsg["direction"] = "Richtung";
      dictMsg["order"] = "Reihenfolge";
      dictMsg["row"] = "Zeile";
      dictMsg["rows"] = "Zeilen";
      dictMsg["page"] = "Seite";
      ...
      dictMsg["error stack download"] = "Fehlerstapel herunterladen";
      dictMsg["maximize"] = "Maximieren";
      dictMsg["restore"] = "Wiederherstellen";
      ...
      dictMsg["repeat new password"] = "Wiederhole neues Passwort";
      ...
      dictMsg["screen id"] = "Bildschirm ID";
      dictMsg["screen ids"] = "Bildschirm IDs";
