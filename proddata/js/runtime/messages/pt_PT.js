...
var pt_PT = function(dict) {
  ...
  switch (dict) {
    case "runtimeMsg":
      ...
      dictMsg["cannot move screen"] = "Não é possível mover o ecrã macro";
      dictMsg["ready to add"] = "(Pronto para adicionar ações ao ecrã)";
      dictMsg["duplicate actions"] = "Encontradas Ações em duplicado  nesta linha / coluna,  o resultado é imprevisível. Reveja as ações e elimine as que estão em duplicado.";
    ...
    case "runtimeText":
      ...
      dictMsg["multi filter text"] = "Filtro por valor";
      dictMsg["filter multiple"] = "Seleccione dados a filtrar";
      dictMsg["filter check"] = "Filtro";
      dictMsg["filter data"] = "Dados";
      dictMsg["find text"] = "Procurar";
      dictMsg["reset data"] = "Reset";
      dictMsg["remove filters text"] = "Remover Todos os Filtros";
      dictMsg["displayed columns"] = "Colunas Mostradas";
      ...
      dictMsg["sort..."] = "Filtrar...";
      dictMsg["sort"] = "Filtrar";
      dictMsg["sort multiple"] = "Filtrar Várias Colunas";
      dictMsg["column"] = "Coluna";
      dictMsg["direction"] = "Direção";
      dictMsg["order"] = "Ordenação";
      dictMsg["row"] = "linha";
      dictMsg["rows"] = "linhas";
      dictMsg["page"] = "Página";
      ...
      dictMsg["error stack download"] = "Download Lista de Erros";
