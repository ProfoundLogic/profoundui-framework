...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "overwrite files", controls: ["file upload", "file upload dnd"], choices: ["true", "false"], type: "boolean", hideFormatting: true, validDataTypes: ["indicator", "expression"], help: pui.helpTextRuntimeProperties("false", "Specifies the action to take when 1 or more files being saved already exists in the IFS target directory. When set to 'true', the existing file(s) will be overwritten. When set to 'false' an error will be returned and no files will be overwritten.", [], "") },
