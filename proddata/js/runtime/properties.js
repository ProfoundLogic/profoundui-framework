...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "icon", type: "icon", help: "Identifies the icon to display in the position specified by the \"icon position\" property. Note for browsers that Internet Explorer 9 and lower, the Material Icon set will not display.", controls: ["css button", "graphic button", "icon"] },
