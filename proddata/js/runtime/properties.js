...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "auto submit", controls: ["file upload dnd"], choices: ["true", "false"], type: "boolean", hideFormatting: true, context: "dspf", validDataTypes: ["indicator", "expression"], help: "After dropping a file and upload finishes, should a page submit happen automatically. The default setting is \"false\"."},
