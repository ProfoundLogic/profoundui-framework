...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "destination parameter value", label: "Parameter Value", readOnly: true, multOccur: true, hide: true, help: "", controls: ["button", "styled button", "graphic button", "hyperlink", "image", "css button"], context: "dspf", viewdesigner: true},
