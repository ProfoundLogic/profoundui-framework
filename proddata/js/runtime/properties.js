...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "chart response", readOnly: true, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("bind", "Specifies a response field to be returned to your program containing the name of the data point selected by the user."), controls: ["chart"], context: "dspf" },
    ...
    { name: "target directory", controls: ["file upload", "file upload dnd"], defaultDataLength: 50, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("blank", "This property specifies the IFS directory where uploaded files will be saved.") },
    { name: "rename to", controls: ["file upload", "file upload dnd"], defaultDataLength: 50, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("blank", "Specifies an alternate file name to be used when the uploaded file is saved.", null, "This property is ignored when more than 1 file is uploaded.") },
...
function getScreenPropertiesModel(designScreen) {
  ...
  if (pui.codeBased) {
    var model = [
      ...
      { name: "document type", choices: ["html", "json", "xml", "text", "csv"], help: pui.helpTextProperties("blank", "Specifies the type of document used to define the record format. This determines the default content type and affects the syntax highlighting within the editor."), hideFormatting: true, validDataTypes: ["char", "varchar"] }, 
      ...
      { name: "content type", help: pui.helpTextProperties("[based on document type]", "Specifies an HTTP response content type. If not specified, a default content type based on the document type is used."), hideFormatting: true, validDataTypes: ["char", "varchar"] }, 
      { name: "attachment name", help: pui.helpTextProperties("blank", "Specifies an attachment file name. When the attachment name is specified, the 'Content-Disposition: attachment' header is sent as part of the HTTP response."), hideFormatting: true, validDataTypes: ["char", "varchar"] }, 
      ...
      { name: "custom header", multOccur: true, type: "long", help: pui.helpTextProperties("[default headers]", "Specifies custom HTTP headers to send as part of the HTTP response."), hideFormatting: true, validDataTypes: ["char", "varchar"] },
  ...
  if (context == "dspf") {
    var model = [
      ...
      { name: "return cursor record", readOnly: true, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("bind", "This property can be bound to a character field, which will be used to receive the name of the record format or screen on which the cursor is located.") }, 
      { name: "return cursor field", readOnly: true, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("bind", "This property can be bound to a character field, which will be used to receive the name of the field on which the cursor is located.") }, 
      ...
      { name: "dd element id", readOnly: true, hideFormatting: true, validDataTypes: ["char", "varchar"], help: pui.helpTextProperties("bind", "This property can be bound to a character field, which will be used to retrieve the id of the element that is drag and dropped.") }, 
