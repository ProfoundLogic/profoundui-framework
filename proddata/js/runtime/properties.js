...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "chart response", wf: true, readOnly: true, hideFormatting: true, validDataTypes: ["char", "varchar", "string"], help: pui.helpTextProperties("bind", "Specifies a response field to be returned to your program containing the name of the data point selected by the user."), controls: ["chart"], context: "dspf" },
...
function getScreenPropertiesModel(designScreen) {
  ...
  if (context == "dspf") {
    var model = [
      ...
      { name: "Events", category: true }, 
      { name: "initial workflow", wf: true, bind: false, readOnly: true, help: pui.helpTextProperties("blank", "Executes a server-side workflow before the screen is displayed.") }, 
...
function evalPropertyValue(propertyValue) {
  ...
  if (pui.isBound(propertyValue) || pui.isTranslated(propertyValue) || pui.isWorkflow(propertyValue)) {
