...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "straight edge", choices: ["all", "left", "right", "top", "bottom"], help: "Determines which parts of the button will have a straight edge instead of rounded corners.", controls: ["mobile button"] },    
