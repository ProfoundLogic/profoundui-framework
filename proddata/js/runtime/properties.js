...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "choices database join", type: "join", help: pui.helpTextProperties("blank", "The Database Join specifications between multiple tables to be used for a dynamic database-driven dropdown box, list box, or text field with autocomplete."), controls: ["combo box", "select box", "textbox"], context: "dspf" },
