...
function getPropertiesModel() {
  ...
  cachedPropertiesModel = [
    ...
    { name: "chart response", readOnly: true, hideFormatting: true, validDataTypes: ["char"], help: pui.helpTextRuntimeProperties("bind", "Specifies a response field to be returned to your program containing the name of the data point selected by the user.", [], ""), controls: ["chart"], context: "dspf" },
    ...
    { name: "destination url", hideFormatting: true, validDataTypes: ["char"], help: pui.helpTextRuntimeProperties("blank", "Specifies an alternate destination URL for the control. The screen will either be submitted to this URL or the browser will navigate to it, depending on the 'redirect to destination' property value.", [], ""), controls: ["button", "styled button", "graphic button", "hyperlink", "image", "css button"], context: "dspf", viewdesigner: true }, 
    ...
    { name: "database file", type: "file", uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Database file to use for the chart's data source. Specify it in the format 'database file' or 'library/database file'.", [], ""), controls: ["chart"] },
    { name: "name field", type: "field", uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Database field that determines the names by which records would be represented in the chart.", [], ""), controls: ["chart"] },
    { name: "value field", type: "field", uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Database field that determines the numerical values from which the chart is to be built.", [], ""), controls: ["chart"] },
    ...
    { name: "selection criteria", type: "long", help: pui.helpTextRuntimeProperties("blank", "Optional expression identifying which records should be retrieved from the database file.", [], ""), controls: ["chart"] },
    ...
    { name: "choices database file", type: "file", uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Database file to be used for a dynamic database-driven dropdown box, list box, or text field with autocomplete. Specify it in the format 'database file' or 'library/database file'.", [], ""), controls: ["combo box", "select box", "textbox"] },
    { name: "choice options field", type: "field", multiple: true, uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Database field name used to retrieve the options for a dynamic dropdown box, list box, combo box, or text field with auto complete. Multiple fields can be specifed for a text field with auto complete. In this case, the field names should be comma separated.", [], ""), controls: ["combo box", "select box", "textbox"] },
    { name: "choice values field", type: "field", uppercase: true, help: pui.helpTextRuntimeProperties("[choice options field]", "Database field name used to retrieve the values sent back to the application. If omitted, the choice options field is used. In the case of a text field with autocomplete that has multiple option fields, the first option field is used.", [], ""), controls: ["combo box", "select box", "textbox"] },
    { name: "choices selection criteria", type: "long", help: pui.helpTextRuntimeProperties("blank", "Optional expression identifying which records should be retrieved from the choices database file.", [], ""), controls: ["combo box", "select box", "textbox"] },
    ...
    { name: "blank option", choices: ["true", "false"], help: pui.helpTextRuntimeProperties("false", "When set to true, a database-driven dropdown box will display a blank option before the options from the database file are displayed.", [], ""), controls: ["combo box", "select box"] },
    ...
    { name: "order by", type: "field", multiple: true, uppercase: true, help: pui.helpTextRuntimeProperties("blank", "Optional expression identifying which fields determine the order of the items. For a database-driven chart, this property is ignored when <i>'summary option'</i> is used. In this case, the items will sort on the <i>'name field'</i>.", [], ""), controls: ["combo box", "select box", "chart"] },
    ...
    { name: "choices url", type: "long", help: pui.helpTextRuntimeProperties("blank", "Sets the url to a Web service that returns the choice options and values in JSON format. If a choices url is used, the database file, choice options field, choice value field, and max choices properties are ignored.", [], ""), controls: ["combo box", "select box", "textbox"] },
    ...
    { name: "target directory", controls: ["file upload", "file upload dnd"], defaultDataLength: 50, hideFormatting: true, validDataTypes: ["char"], help: pui.helpTextRuntimeProperties("blank", "This property specifies the IFS directory where uploaded files will be saved.", [], "") },
    { name: "rename to", controls: ["file upload", "file upload dnd"], defaultDataLength: 50, hideFormatting: true, validDataTypes: ["char"], help: pui.helpTextRuntimeProperties("blank", "Specifies an alternate file name to be used when the uploaded file is saved.", ["note"], "This property is ignored when more than 1 file is uploaded.") },
...
function getScreenPropertiesModel(designScreen) {
  ...
  if (pui.codeBased) {
    var model = [
      ...
      { name: "content type", help: pui.helpTextRuntimeProperties("[based on document type]", "Specifies an HTTP response content type. If not specified, a default content type based on the document type is used.", [], ""), hideFormatting: true, validDataTypes: ["char"] }, 
      { name: "attachment name", help: pui.helpTextRuntimeProperties("blank", "Specifies an attachment file name. When the attachment name is specified, the 'Content-Disposition: attachment' header is sent as part of the HTTP response.", [], ""), hideFormatting: true, validDataTypes: ["char"] }, 
      ...
      { name: "custom header", multOccur: true, type: "long", help: pui.helpTextRuntimeProperties("[default headers]", "Specifies custom HTTP headers to send as part of the HTTP response.", [], ""), hideFormatting: true, validDataTypes: ["char"] },
  ...
  if (context == "dspf") {
    var model = [
      ...
      { name: "dd element id", readOnly: true, hideFormatting: true, validDataTypes: ["char"], help: pui.helpTextRuntimeProperties("bind", "This property can be bound to a character field, which will be used to retrieve the id of the element that is drag and dropped.", [], "") }, 
