...
pui["runtimeText"]["en_US"]["ctlr job"]             = "Controller Job";
pui["runtimeText"]["en_US"]["app job"]              = "Application Job";
pui["runtimeText"]["en_US"]["joblog download"]      = "Download Job Logs";
pui["runtimeText"]["en_US"]["curr user"]            = "Current User";
pui["runtimeText"]["en_US"]["remote ip"]            = "Remote IP Address";
pui["runtimeText"]["en_US"]["remote port"]          = "Remote Port";
...
pui["runtimeText"]["de_DE"]["ctlr job"]             = "Steuernder Job";
pui["runtimeText"]["de_DE"]["app job"]              = "Anwendungsjob";
pui["runtimeText"]["de_DE"]["joblog download"]      = "Job Logs Herunterladen";
pui["runtimeText"]["de_DE"]["curr user"]            = "Aktueller Benutzer";
pui["runtimeText"]["de_DE"]["remote ip"]            = "Server IP Adresse";
pui["runtimeText"]["de_DE"]["remote port"]          = "Server Port";
...
// pui["runtimeText"]["pt_PT"]["ctlr job"]             = "Controller Job";
// pui["runtimeText"]["pt_PT"]["app job"]              = "Application Job";
// pui["runtimeText"]["pt_PT"]["joblog download"]      = "Download Job Logs";
// pui["runtimeText"]["pt_PT"]["curr user"]            = "Current User";
// pui["runtimeText"]["pt_PT"]["remote ip"]            = "Remote IP Address";
// pui["runtimeText"]["pt_PT"]["remote port"]          = "Remote Port";
...
pui["runtimeText"]["es_ES"]["ctlr job"]             = "Trabajo Controlador";
pui["runtimeText"]["es_ES"]["app job"]              = "Trabajo de Aplicación";
pui["runtimeText"]["es_ES"]["joblog download"]      = "Descargar pistas de auditoria del trabajo";
pui["runtimeText"]["es_ES"]["curr user"]            = "Usuario Actual";
pui["runtimeText"]["es_ES"]["remote ip"]            = "Dirección IP Remota";
pui["runtimeText"]["es_ES"]["remote port"]          = "Puerto Remoto";
...
pui["runtimeText"]["es_MX"]["joblog download"]        = "Descargar Job Logs";
// Translated for feature #2826, but rest of Atrium translations still required.
...
pui["runtimeText"]["fr_FR"]["ctlr job"]             = "Travail Serveur";
pui["runtimeText"]["fr_FR"]["app job"]              = "Travail";
pui["runtimeText"]["fr_FR"]["joblog download"]      = "Télécharger l'Historique du Travail";
pui["runtimeText"]["fr_FR"]["curr user"]            = "Utilisateur Courant";
pui["runtimeText"]["fr_FR"]["remote ip"]            = "Adresse IP Distante";
pui["runtimeText"]["fr_FR"]["remote port"]          = "Port Distant";
...
pui["runtimeText"]["fr_CA"]["ctlr job"]             = "Travail Serveur";
pui["runtimeText"]["fr_CA"]["app job"]              = "Travail";
pui["runtimeText"]["fr_CA"]["joblog download"]      = "Télécharger l'Historique du Travail";
pui["runtimeText"]["fr_CA"]["curr user"]            = "Utilisateur Courant";
pui["runtimeText"]["fr_CA"]["remote ip"]            = "Adresse IP Distante";
pui["runtimeText"]["fr_CA"]["remote port"]          = "Port Distant";
...
pui["runtimeText"]["it_IT"]["ctlr job"]             = "Job di controllo";
pui["runtimeText"]["it_IT"]["app job"]              = "Application job";
pui["runtimeText"]["it_IT"]["joblog download"]      = "Scarica job log";
pui["runtimeText"]["it_IT"]["curr user"]            = "Utente corrente";
pui["runtimeText"]["it_IT"]["remote ip"]            = "Indirizzo IP remoto";
pui["runtimeText"]["it_IT"]["remote port"]          = "Porta remota";
...
// pui["runtimeText"]["he_IL"]["ctlr job"]             = "Controller Job";
// pui["runtimeText"]["he_IL"]["app job"]              = "Application Job";
// pui["runtimeText"]["he_IL"]["joblog download"]      = "Download Job Logs";
// pui["runtimeText"]["he_IL"]["curr user"]            = "Current User";
// pui["runtimeText"]["he_IL"]["remote ip"]            = "Remote IP Address";
// pui["runtimeText"]["he_IL"]["remote port"]          = "Remote Port";
...
pui["runtimeText"]["nl_NL"]["ctlr job"]               = "Controle Taak";
pui["runtimeText"]["nl_NL"]["app job"]                = "Applicatie Taak";
pui["runtimeText"]["nl_NL"]["joblog download"]        = "Download Taak Logboeken";
pui["runtimeText"]["nl_NL"]["curr user"]              = "Huidige Gebruiker";
pui["runtimeText"]["nl_NL"]["remote ip"]              = "IP adres op Afstand";
pui["runtimeText"]["nl_NL"]["remote port"]            = "Poortnummmer op Afstand";
